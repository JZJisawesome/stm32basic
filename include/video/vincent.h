//From https://forum.osdev.org/viewtopic.php?f=2&t=22033
#ifndef VINCENT_H
#define VINCENT_H 1
...
const uint8_t vincentFont[128][8] = { 
  ...
  { 0x00, 0x06, 0x0C, 0x18, 0x18, 0x18, 0x0C, 0x06 }, //'('//Flipped with entry below from original font
  { 0x00, 0x60, 0x30, 0x18, 0x18, 0x18, 0x30, 0x60 }, //')'//Because ( and ) were backwards
