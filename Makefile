...
DEPS = $(INCDIR)/common/bluepill.h $(INCDIR)/common/fifo.h $(INCDIR)/common/spibus.h $(INCDIR)/video/composite.h $(INCDIR)/video/softrenderer.h $(INCDIR)/video/vincent.h
...
$(BUILDDIR)/video/video: $(BUILDDIR)/common/bluepill.o $(BUILDDIR)/common/fifo.o $(BUILDDIR)/common/spibus.o $(BUILDDIR)/video/video.o $(BUILDDIR)/video/composite.o $(BUILDDIR)/video/softrenderer.o | $(BUILDDIR)/video
	$(CC) $(CFLAGS) $(LINKEROPTS) $(BUILDDIR)/common/bluepill.o $(BUILDDIR)/common/fifo.o $(BUILDDIR)/common/spibus.o $(BUILDDIR)/video/video.o $(BUILDDIR)/video/composite.o $(BUILDDIR)/video/softrenderer.o -o $(BUILDDIR)/video/video
