...
$(BUILDDIR)/video/video: $(BUILDDIR)/common/bluepill.o $(BUILDDIR)/video/video.o $(BUILDDIR)/video/composite.o $(BUILDDIR)/video/processing.o $(BUILDDIR)/video/ps2uart_video.o $(BUILDDIR)/video/softrenderer.o $(BUILDDIR)/video/spiio_video.o | $(BUILDDIR)/video
	$(CC) $(CFLAGS) $(LINKEROPTS) $(BUILDDIR)/common/bluepill.o $(BUILDDIR)/video/video.o $(BUILDDIR)/video/composite.o $(BUILDDIR)/video/processing.o $(BUILDDIR)/video/ps2uart_video.o $(BUILDDIR)/video/softrenderer.o $(BUILDDIR)/video/spiio_video.o -o $(BUILDDIR)/video/video
